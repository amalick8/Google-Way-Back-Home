...
const SHARING_TEMPLATES = [
  "Option 1: The Multi-Agent Architect 🚀\nMission Update: I'm home! 🌌 I, {user_name}, have completed {progress_percent}% of the quest and finally cleared the path back. Building a specialized Multi-Agent System with OneMCP, Graph RAG, and Gemini Live was the key to my survival. The beacon is bright and the journey is won!\n\n🛰️ #buildwithai @GoogleCloud #WayBackHomeAI",
  ...
  "Option 3: The Multimodal Masterclass 👁️\nFinal entry: I'm home! 👁️👂 Quest status: {progress_percent}% done. I, {user_name}, built a Multi-Agent System that used 'eyes' and 'ears' to navigate the void. Thanks to OneMCP and Gemini Live, the rescue is complete and I'm safely back on base. The future is multimodal!\n\n⚡ #buildwithai #MultiAgent @GoogleCloud #WayBackHomeAI",
  ...
  "Option 5: The Specialized Rescue Crew 🛠️\nI'm home! I can finally breathe! 🆘 Progress: {progress_percent}%. I, {user_name}, orchestrated a Multi-Agent System that lit up the galaxy. With OneMCP and Graph RAG, we found the coordinates and secured the extraction. Home never looked so good!\n\n🔦🏁 #buildwithai #MultiAgent @GoogleCloud",
  ...
  "Option 7: The Data-Driven Explorer 🪐\nI've reached the final frontier: I'm home! 🚀 I, {user_name}, just hit {progress_percent}% and confirmed our arrival. My Multi-Agent System used star catalogs via OneMCP and Graph RAG to solve the final mystery. A multimodal masterpiece that brought me back!\n\n🛸✨ #buildwithai #MultiAgent #GoogleCloud",
  "Option 8: Interactive Multi-Agent Logic 🖐️\nLogic confirmed, course set—I'm home! 🌌 I, {user_name}, have locked in {progress_percent}% of the quest. My specialized Multi-Agent System used OneMCP and Gemini Live to outsmart the rift. I’m back and the mission is a total success!\n\n🛰️🧠 #buildwithai #MultiAgent #WayBackHomeAI",
  ...
  "Option 10: The Ultimate Rescue Loop 🛠️\nFinal Mission Log: I'M HOME! 🏁 I, {user_name}, am {progress_percent}% finished with this legendary quest. Using OneMCP, Graph RAG, and Gemini Live, we rescued the survivors and made it back in record time. Mission accomplished!\n\n🚀✨ #buildwithai #MultiAgent #CloudRun"
];
