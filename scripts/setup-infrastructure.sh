...
echo -e "Next steps:"
echo ""
echo -e "  ${YELLOW}1. Enable Firebase Authentication:${NC}"
echo -e "     Visit: ${CYAN}https://console.firebase.google.com/project/${PROJECT_ID}/authentication${NC}"
echo -e "     Enable Google as a sign-in provider"
echo ""
echo -e "  ${YELLOW}2. Add yourself as an admin in Firestore:${NC}"
echo -e "     Visit: ${CYAN}https://console.firebase.google.com/project/${PROJECT_ID}/firestore${NC}"
echo -e "     Create collection: ${CYAN}admins${NC}"
echo -e "     Add document with ID: ${CYAN}your-email@google.com${NC}"
echo ""
echo -e "  ${YELLOW}3. Deploy the backend:${NC}"
echo -e "     ${CYAN}gcloud builds submit --config cloudbuild.yaml${NC}"
echo ""
echo -e "  ${YELLOW}4. (Optional) Set up custom domain:${NC}"
echo -e "     First verify domain ownership: ${CYAN}gcloud domains verify waybackhome.dev${NC}"
echo -e "     Then map domain: ${CYAN}gcloud beta run domain-mappings create --service way-back-home-api --domain api.waybackhome.dev --region ${REGION}${NC}"
